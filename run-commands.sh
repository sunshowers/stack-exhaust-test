...
# 
# Note that the red zone is set to 16MiB to ensure that a segment is always
# created.
...
run --use-stacker once --red-zone $((16 * 1024 * 1024))
run --new-thread
run --new-thread --use-stacker once
run --new-thread --use-stacker always
run --new-thread --use-stacker once --red-zone $((16 * 1024 * 1024))
